...
function _cb_findItemsByKeywords(root){
    // console.log(root);
    let item = root.findItemsByKeywordsResponse[0].searchResult[0].item || [];
    let html = [];
    html.push('<div class="post h2 v2">');
    for(var idx=0; idx < item.length; ++idx){
        let itemimage = item[0].galleryURL;
        let viewitem = item[0].viewItemURL;
        if ( null !== viewitem ) {
