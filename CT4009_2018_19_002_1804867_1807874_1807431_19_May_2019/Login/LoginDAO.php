    ...
    if(isset($_POST['email']) && !empty($_POST['email']) AND isset($_POST['password']) && !empty($_POST['password'])) { // if a value exists in sent data
        ...
        if(@mysqli_num_rows($result) == 1) { // if a match was found
            ...
            if(password_verify($password, $hash_pw)) { // check that hashed passwords match
                ...
                header("Location: http://ct4009-saming.studentsites.glos.ac.uk/CT4009_2018_19_002_1804867_1807874_1807431_19_May_2019/User/BlockReportUser/BlockReportUser.php"); // redirect user to defacto dashboard
                ob_end_clean();
                exit();
            } else { // return to login page with query string authCheck=false
                 header("Location: http://ct4009-saming.studentsites.glos.ac.uk/CT4009_2018_19_002_1804867_1807874_1807431_19_May_2019/index.php?authCheck=false"); 
                 closeConnection($connection);
                 exit();
            }
           ...
           // return false; 
           header("Location: http://ct4009-saming.studentsites.glos.ac.uk/CT4009_2018_19_002_1804867_1807874_1807431_19_May_2019/index.php?authCheck=false"); // display error page
           closeConnection($connection);
           exit();
