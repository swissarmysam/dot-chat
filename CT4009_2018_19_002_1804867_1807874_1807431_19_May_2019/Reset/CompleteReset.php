    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <div class="container">
                ...
                <!-- Form begins -->
                <div id="warning"></div>
                <form id="userVerifyPwForm" method="post" action="./CompleteResetDAO.php"> <!-- submit form as POST as it contains user information -->
                    ...
                    <div class="form-container">
                        ...
                        <input class="field-text" type="password" id="enter_assword" name="password" placeholder="Enter a secure password"
